        ...
        <div>
          ...
          <div>
            <input
              ...
              name="address"
              required
              className="rounded-full border border-stone-200 px-4 py-2 text-sm transition-all duration-300 placeholder:text-stone-400 focus:outline-none focus:ring focus:ring-amber-500 w-full md:px-6 md:py-3"
            />
          </div>
        </div>
